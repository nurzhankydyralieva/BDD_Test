...
public class IntegrationCreateFeaturesSteps {
    ...
    private ResponseEntity<TrainerResponseOkDTO> responseEntity;
    ...
    public void a_trainer_request_with_valid_data() {
        ...
        responseEntity = restTemplate.postForEntity(url, requestDTO, TrainerResponseOkDTO.class);
    }

    @When("The createTrainer endpoint is called")
    public void theC_create_trainer_endpoint_is_called() {
